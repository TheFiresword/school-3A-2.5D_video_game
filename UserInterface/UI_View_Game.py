...
from UserInterface.UI_PoP_Up import PoP_Up_Text_Section
...
class GameView(arcade.View):
    ...
    def __init__(self, _game):
        ...
        #Fire PoP_Up
        text = constantes.SPRITE_PATH + "Pictures/feu2.png"
        Fire_Pop_up = pop.create_PoP_Up(image=constantes.SPRITE_PATH + "Pictures/feu2.png", title="Fire in the city",
        ...
        #Collapse PoP_Up
        Collapse_Pop_up = pop.create_PoP_Up(image=constantes.SPRITE_PATH + "Pictures/effondrement.png", title="Building Collapse",
                                        normal_text="tchoupi", carved_text="Nov 340 BC              To The new governor\n"
                                        ...
                                        order=["title_zone", "image_zone", "carved_text_zone", "button_zone"])
        #City debt PoP_Up
        City_debt_Pop_up = pop.create_PoP_Up(image=constantes.SPRITE_PATH + "Pictures/caesar.png",title="City debt",
                                        normal_text="tchoupi", carved_text="Nov 340 BC              To The new governor\n"
        ...
        self.actual_pop_up = pop.info_building_pop_up("aqueduct",6,6)
