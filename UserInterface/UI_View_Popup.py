...
from Services import servicesmMapSpriteToFile as serv
...
class MyWindow(arcade.Window):
    ...
    def __init__(self):
        ...
        #sprite info_batiment
        self.occupant_list = None
        self.occupant_sprite = None

        #background
        self.background_popup = arcade.load_texture(serv.mapping_function("building","panel1"))
        self.background_popup1 = arcade.load_texture(serv.mapping_function("building","ph"))
        ...
        #managers des boutons et panels
    ...
    def setup_welcome(self):
        panel_welcome = load_texture("Window03.png")
    ...
    def setup_infobatiment(self):
        ...
        # sprite info_batiment
        self.occupant_list = arcade.SpriteList()
        self.occupant_sprite = arcade.Sprite("citizen02_00791.png", 1)
        self.occupant_sprite.center_x = HEIGHT / 2 - 200
        self.occupant_sprite.center_y = WIDTH / 2 + 160
        self.occupant_list.append(self.occupant_sprite)


    def setup_incendie(self):
        # sprite d'incendie
        self.picture_list = arcade.SpriteList()
        self.picture_sprite = arcade.Sprite("10b_00001.png", PICTURE_SCALING - 0.05)
        ...
        panel_urgence = load_texture("PanelWindow.png")
        self.text_incendie = ("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget pellentesque velit. "
        ...
        text_area_incendie = UITextArea(x=200,
                               y=160,
                               width=400,
                               height=150,
                               text=self.text_incendie,
                               text_color=(254, 254, 250))
    ...
    def setup_effondrement(self):
        ...
        panel_urgence = load_texture("PanelWindow.png")
        self.text_effondrement = (
            "Aorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget pellentesque velit. "
            "Nam eu rhoncus nulla. Fusce ornare libero eget ex vulputate, vitae mattis orci eleifend. "
            "Donec quis volutpat arcu. Proin lacinia velit id imperdiet ultrices. Fusce porta magna leo, "
            "non maximus justo facilisis vel. Duis pretium sem ut eros scelerisque, a dignissim ante "
            "pellentesque. Cras rutrum aliquam fermentum. Donec id mollis mi.\n"
        ...
        text_area_effondrement = UITextArea(x=200,
                                        y=160,
                                        width=400,
                                        height=150,
                                        text=self.text_effondrement,
                                        text_color=(254, 254, 250))
        self.manager_Panel_effondrement.add(
            UITexturePane(
                text_area_effondrement,
                tex=panel_urgence,
                padding=(10, 10, 10, 10)
            )
        )
    ...
    def Popup(self,case):
        if case == "incendie":
            arcade.draw_lrwh_rectangle_textured(150, 50, WIDTH/2 + 200, HEIGHT/2 + 100, self.background_popup)
        ...
        if case == "effondrement":
            arcade.draw_lrwh_rectangle_textured(150, 50, WIDTH/2 + 200, HEIGHT/2 + 100, self.background_popup)
            self.manager_Panel_effondrement.draw()
            self.manager_ok.draw()
    ...
    def Popup_Info_Batiment(self):
        ...
        arcade.draw_lrwh_rectangle_textured(170, 480, WIDTH / 2 -100 , HEIGHT / 2 - 500 , self.background_popup1)
        self.occupant_list.draw()
    ...
    def on_click_open(self, event):
        ...
        self.manager_Panel_effondrement.enable()
