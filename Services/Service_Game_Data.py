...
building_dico = {
    ...
    "fruit farm": Building_info(40, -1, 10, "ffarm", True, False),
    ...
    "olive farm": Building_info(40, -1, 10, "ofarm", True, False),
    "palisade": Building_info(6, -1, 0, "", False, False),
    "plaza": Building_info(15, -1, 0, "plaza", False, False),
    "pig farm": Building_info(40, -1, 10, "pfarm", True, False),
    ...
    "vegetable farm": Building_info(40, -1, 10, "vfarm", True, False),
    "vine farm": Building_info(40, -1, 10, "vifarm", True, False),
    "watchtower": Building_info(100, -1, 10, "", False, True),
    "weapons workshop": Building_info(40, -1, 10, "weapons_workshop", True, False),
    "wheat farm": Building_info(40, -1, 10, "wfarm", True, False),
